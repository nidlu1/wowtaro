...
<div class="inner">
  <div class="order-wr clearfix">
    <ul class="mypage-tab">
      <li><a class="on" href="/shop/orderinquiry.php">상담내역</a></li>
      <li><a>코인/결제내역</a></li>
      <li><a>나의 상담후기</a></li>
      <li><a>나의 상담문의</a></li>
      <li><a>코인충전</a></li>
      <li><a href="/bbs/member_confirm.php?url=register_form.php">내 정보 수정</a></li>
      <li><a href="/shop/wishlist.php">단골 상담사</a></li>
    </ul>
