...
?>
	  ...
	  <li><a <?php echo preg_match("/register_form2/", $_SERVER['PHP_SELF']) ? "class='on'" : ""; ?> href="/bbs/member_confirm.php?url=register_form2.php">내 정보 수정</a></li>
...
?>
	  ...
	  <li><a><?php echo $member['mb_nick']; ?>님</a></li>
          <li><a>보유 포인트: <?=$member['mb_point']?> </a></li>
      ...
      <li><a <?php echo preg_match("/register_form/", $_SERVER['PHP_SELF']) ? "class='on'" : ""; ?> href="/bbs/member_confirm.php?url=register_form.php">내 정보 수정</a></li>
	  ...
	  <li><a href="/bbs/member_confirm.php?url=member_leave.php">회원탈퇴</a></li>
          <li><a class="review_pop_open">상담후기 운영 정책</a></li>
			<!-- <li><a>&nbsp;</a></li> -->
<?php
}
