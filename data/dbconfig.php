...
$g5['member_table2'] = G5_TABLE_PREFIX.'member2'; // 상담사 회원 신청 테이블
...
$g5['hashtag_table'] = G5_TABLE_PREFIX.'hashtag'; // 해시태그정보 테이블
$g5['recommhash_table'] = G5_TABLE_PREFIX.'recommhash'; // 추천해시태그정보 테이블
$g5['pay_table'] = G5_TABLE_PREFIX.'pay'; // 결제금액정보 테이블
$g5['pay_history'] = G5_TABLE_PREFIX.'pay_history'; // 회원별 상품별 구매이력 테이블
