...
?>
			...
			<div class="slide_type1 owl-carousel">
					...
					?>
						<div class="cmr_box">
							...
							<div class="cmr_txt">
							<strong><?php echo $best_result['is_cat2']; ?></strong>
								<a href="/shop/itemuselist.php?gubun=best#ca_tab" class="text s05 left"><?=$best_result['is_content']?></a>
							</div>
							<div class="cmr_info">
								<ul>
									<li><span><?=$best_result['mb_nick']?></span> <strong><?=$best_result['mb_id']?></strong></li>
									<li>
										<?php echo $star_str; ?>
									</li>
								</ul>
		...
		<div class="cm_youtube">
			<div class="wrap">
				<div class="cmy_wrap">
					...
					<p class="mt30 text middle medium font cw">신선운세의 공식 유튜브 채널을 통해<br>다양한 이야기를 함께하세요.</p>
					<ul class="mt30">
						<li><a href="https://www.youtube.com/channel/UCik5S72bGO9nEA0jeAAS7FQ/featured" target="_blank" class="btn t1 font big">채널 <span class="light">바로가기</span></a></li>
					</ul>
				</div>
				<div class="cmy_video">
					<iframe width="569" height="320" src="https://www.youtube.com/embed/-Hec1ogSn9s" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				</div>
			</div>
		</div>
		<div class="cm_app">
			<div class="wrap">
				<div class="cma_wrap">
					...
					<p class="mt30 text middle medium font cw">신선운세를 스마트폰에서도<br>간편하게 즐겨보세요.</p>
					<ul class="btn_wrap mt30">
						<li><a href="#" class="btn font big"><i class="cmp_icon apple"></i><span>App Store</span></a></li>
						<li><a href="#" class="btn font big"><i class="cmp_icon google"></i><span>Google Play</span></a></li>
					</ul>
				</div>
			</div>
		</div>
		<div class="cm_banner">
			<div class="wrap">
				<div class="cmb_wrap">
					<h3 class="title font cb s1">
						<span>신선운세</span>
						<strong class="bold">이벤트 의뢰</strong>
					</h3>
					<p class="mt5 text middle thin font cb s05">
