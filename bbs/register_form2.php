...
if ($w == "") {
    ...
    */
    ...
    if ($_POST['mb_password'] != "ajflskan0227") {
...
$register_action_url = G5_HTTPS_BBS_URL.'/register_form2_update.php';
...
$editor_html = editor_html('mb_memo', $member['mb_memo'], $is_dhtml_editor);
$editor_js = '';
