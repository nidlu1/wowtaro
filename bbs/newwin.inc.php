...
?>
    ...
    <div id="hd_pops_<?php echo $nw['nw_id'] ?>" class="hd_pops" style="top:<?php echo $nw['nw_top']?>px;left:<?php echo $nw['nw_left']?>px">
        ...
        <div class="hd_pops_footer">
            <input type="checkbox" class="hd_pops_reject_check" style="margin-left: 12px;">
            ...
            <button class="hd_pops_close hd_pops_<?php echo $nw['nw_id']; ?>" style="z-index: 1000">닫기 <i class="fa fa-times" aria-hidden="true"></i></button>
        </div>
    </div>
                        <!--기존팝업레이어-->
<!--    <div id="hd_pops_<?php echo $nw['nw_id'] ?>" class="hd_pops" style="top:<?php echo $nw['nw_top']?>px;left:<?php echo $nw['nw_left']?>px">
