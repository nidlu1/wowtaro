...
<div id="hd">
  <div id="hd_wr">
    <div id="logo"><a href="http://fortune.urbannet.co.kr/shop/"><img src="/m-fortune-img/logo.png" alt="신선운세"></a></div>
  </div>
</div>
...
<div id="mb_login" class="mbskin">
    ...
    <div id="login_frm">
        ...
        <input type="text" name="mb_id" id="login_id" placeholder="아이디(필수)" required class="frm_input">
    ...
    <section class="mb_login_join">
        ...
        <div>
          <!--아이디찾기 비밀번호 찾기 분리-->
            <a href="<?php echo G5_BBS_URL ?>/password_lost.php" target="_blank" id="login_password_lost">아이디 찾기</a>
