    ...
    <div class="form_01">
      ...
      <!--//승인받은날짜 노출하기-->
        <li>
            ...
            <input type="text" name="mb_id" placeholder="이메일만 사용가능합니다" value="<?php echo $member['mb_id'] ?>" id="reg_mb_id" <?php echo $required ?> <?php echo $readonly ?> class="frm_input strip_input <?php echo $required ?> <?php echo $readonly ?>" minlength="3" maxlength="40" placeholder="아이디" style="border: 0;">
            <!--<button type="button" class="btn_frmline">인증확인</button>-->
        ...
        <span class="input_3_wrap">
				...
				<select id="mb_hp1" name="mb_hp1" onchange="resetAuth()">
          ...
          <li>
              ...
              <input type="text" name="mb_email" value="<?php echo isset($member['mb_email'])?$member['mb_email']:''; ?>" id="reg_mb_email" required class="frm_input strip_input required" size="70" maxlength="100" placeholder="E-mail">
          </li>
          ...
          <li>
              ...
              <div class="frm_input required">
				...
				?>
        <span class="info_text">상담분야는 2개까지 선택 가능합니다.</span>
              </div>
          </li>
          <li>
              <label class="form_label">세부분야</label>
              <div class="frm_input form_padding_right required">
				<?php
				...
				?>
        <span class="info_text">세부분야는 3개까지 선택 가능합니다.</span>
             </div>
          </li>
		  <li>
          ...
          <li>
			...
			<li>
              ...
              <!-- <div class="editor"> -->
			  <textarea name="mb_memo" id="reg_mb_memo" class="" style="height:200px;<?php echo $w=='u' ? 'border: 0;' : ''; ?>" placeholder="상담사 소개글" <?php echo $w=='u' ? 'readOnly' : ''; ?>><?php echo $member['mb_memo'] ?></textarea>
