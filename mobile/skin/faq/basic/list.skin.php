...
<div class="c_hero" id="sub_callcenter">
	<strong>신선운세 <mark>FAQ</mark></strong>
</div>
<div class="c_list">
	<div class="cl_menu">
		...
		<span>신선운세</span>
		<span>고객센터</span>
		<span><mark><a href="/bbs/faq.php?fm_id=4" class="sct_here ">FAQ</a></mark></span>
	</div>
</div>
<!-- FAQ 시작 { -->
<div class="c_area faq">
	<div class="wrap">
			...
			?>
				...
				<ol>
					...
					<li>
						<div class="caf_wrap">
							<h3 class="caf_title">
								<i class="caf_icon">Q</i><a href="#none" onclick="return faq_open(this);"><div><?php echo conv_content($v['fa_subject'], 1); ?></div></a>
							</h3>
