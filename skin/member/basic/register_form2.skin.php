...
<?php } else { ?>
	...
	<div class="c_list">
		<div class="cl_menu">
			...
			<span>신선운세</span>
			<span>마이페이지</span>
			<span><mark><a href="/bbs/register_form2.php" class="sct_here">상담사정보수정</a></mark></span>
		</div>
...
?>
						...
						<div class="caf_item">
							...
							<input type="text" name="mb_9" value="<?php echo $member['mb_9'] ?>" id="reg_mb_9" class="caf_input w100p" maxlength="20" placeholder="나를 어필할 수 있는 한줄소개">
							<span class="caf_comment">20자 이내</span>
						</div>
						<div class="caf_item">
							<label class="form_label">상담사 경력</label>
							<textarea name="mb_profile" id="reg_mb_profile" <?php echo $config['cf_req_profile'] ? "required" : ""; ?> class="caf_textarea <?php echo $config['cf_req_profile'] ? "required" : ""; ?>" style="height:100px;" placeholder="상담사 경력" <?php echo $w == 'u' ? ' readOnly' : ''; ?>><?php echo $member['mb_profile'] ?></textarea>
						</div>
						<div class="caf_item">
							<label class="form_label">상담사 소개글</label>
							<div class="editor">
								<textarea name="mb_memo" id="reg_mb_memo" class="caf_textarea" style="height:170px;<?php echo $w == 'u' ? 'border: 0;' : ''; ?>" placeholder="상담사 소개글" <?php echo $w == 'u' ? ' readOnly' : ''; ?>><?php echo $member['mb_memo'] ?></textarea>
<?php //echo $editor_html; // 에디터 사용시는 에디터로, 아니면 textarea 로 노출     ?>
								<span class="caf_comment">300자 이내</span>
							</div>
						</div>
						<div class="caf_item">
						...
						<?php if ($w != 'u') { ?>
							<input type="button" class="btn middle t2 mt50 mb20" id="btn-digital-signature" value="전자계약서 보기">
				...
				<div class="caf_buttons">
					<a href="<?php echo G5_URL ?>" class="btn middle mr20 fl">취소</a>
					<input type="submit" value="<?php echo $w == '' ? '상담사신청' : '정보수정'; ?>" id="btn_submit" class="btn t1 middle fl" accesskey="s">
				</div>
