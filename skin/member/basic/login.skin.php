...
?>
<div id="hd_wrapper" class="clearfix" style="margin-top:48px;">
    <div id="logo"><a href="/index.php" alt="신선운세"><img src="/fortune-img/logo.png" class="main_logo" title=""></a></div>
</div>
...
<div id="mb_login" class="mbskin">
    ...
    <aside id="login_info">
        <h2>회원로그인 안내</h2>
        <div>
			<a href="<?php echo G5_BBS_URL ?>/id_lost.php" target="_blank" id="login_password_lost">아이디 찾기</a>
