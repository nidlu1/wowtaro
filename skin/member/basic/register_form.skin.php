          ...
          <?php } else { ?>
            ...
            <li>
                ...
                <?php if($w != 'u'){ ?>
                  ...
                  <button type="button" id="dup_id" class="btn_frmline">중복확인</button>
                <?php } else { ?>
            ...
            <li>
              <label for="reg_mb_nick" class="form_label">닉네임</label>
                <label for="reg_mb_nick" class="sound_only">닉네임<strong>필수</strong></label>
                    ...
                    <input type="text" name="mb_nick" value="<?php echo isset($member['mb_nick'])?get_text($member['mb_nick']):''; ?>" id="reg_mb_nick" required class="frm_input required nospace strip_input" size="10" maxlength="20" placeholder="공백없이 한글,영문,숫자 입력가능(한글2자,영문 4자이상)">
            ...
            <li>
                  ...
                  <input type="password" name="mb_password_origin" id="reg_mb_password_origin" placeholder="현재 비밀번호를 입력해주세요" class="frm_input  " minlength="3" maxlength="20" placeholder="비밀번호">
            </li>
            <li>
                  ...
                  <input type="password" name="mb_password" id="reg_mb_password" placeholder="새 비밀번호를 입력해주세요" class="frm_input  " minlength="3" maxlength="20" placeholder="비밀번호 확인">
            </li>
            <li>
                  ...
                  <input type="password" name="mb_password_re" id="reg_mb_password_re" placeholder="새 비밀번호를 한번 더 입력해주세요" class="frm_input  " minlength="3" maxlength="20" placeholder="비밀번호 확인">
            </li>
            <?php }  ?>
            <!-- <li>
            ...
            <?php if ($config['cf_use_hp'] || $config['cf_cert_hp']) {  ?>
              <label for="reg_mb_hp" class="form_label">휴대폰번호</label>
				...
				<select id="mb_hp1" name="mb_hp1" onchange="resetAuth()" class="frm_input third_input">
				...
				<input type="text" name="mb_hp2" value="<?php echo get_text($arr_hp[1]) ?>" id="mb_hp2" <?php echo ($config['cf_req_hp'])?"required":""; ?> style="width:100px;" class="frm_input third_input <?php echo ($config['cf_req_hp'])?"required":""; ?>" maxlength="4" onchange="resetAuth()">
				<input type="text" name="mb_hp3" value="<?php echo get_text($arr_hp[2]) ?>" id="mb_hp3" <?php echo ($config['cf_req_hp'])?"required":""; ?> style="width:100px;" class="frm_input third_input <?php echo ($config['cf_req_hp'])?"required":""; ?>" maxlength="4" onchange="resetAuth()">
			...
			<li>
				...
				<input type="text" name="mb_recommend" id="reg_mb_recommend" class="frm_input full_input" placeholder="추천인아이디를 입력해 주세요.">
			</li>
			<?php } ?>
