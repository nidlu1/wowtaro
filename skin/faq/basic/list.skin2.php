	...
	<div class="wrap">
		...
		<?php } ?>
		 -->	<!-- <div class="ca_tabs" id="ca_tab">
					<ul>
						<li class="on"><a href="/bbs/faq.php?fm_id=4#ca_tab"><span>FAQ</span></a></li>
			...
			?>
				...
				<ol>
					...
					<li>
						<div class="caf_wrap">
							<h3 class="caf_title">
								<i class="caf_icon"></i><a href="#none" onclick="return faq_open(this);"><?php echo conv_content($v['fa_subject'], 1); ?></a>
							</h3>
