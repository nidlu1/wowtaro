...
if ($w == '') {
    ...
    $mb['mb_hashtag'] = get_text($mb['mb_hashtag']);
} else
    alert('제대로 된 값이 넘어오지 않았습니다.');

$is_dhtml_editor = true;
$editor_html = editor_html('mb_memo', $mb['mb_memo'], $is_dhtml_editor);
$editor_js = '';
$editor_js .= get_editor_js('mb_memo', $is_dhtml_editor);
$editor_js .= chk_editor_js('mb_memo', $is_dhtml_editor);
...
<form name="fmember" id="fmember" action="./member_form_update2.php" onsubmit="return fmember_submit(this);" method="post" enctype="multipart/form-data">
    ...
    <input type="hidden" id="mb_no" name="mb_no" value="<?php echo $mb['mb_no'] ?>">
...
if ($w == '') {
    ...
    <?php if ($w == 'u') { ?><a href="./boardgroupmember_form.php?mb_id=<?php echo $mb['mb_id'] ?>" class="btn_frmline">접근가능그룹보기</a><?php } ?>
                            ...
                            ?>
                        <th scope="row"><label for="mb_id2">아이디<?php echo $sound_only ?></label></th>
                        <td>
                            <input type="hidden" id="mb_id" name="mb_id" value="<?php echo $mb['mb_id'] ?>">
                            <input type="text" name="mb_id2" value="<?php echo $mb['mb_id'] ?>" id="mb_id2" <?php echo $required_mb_id ?> class="frm_input <?php //echo $required_mb_id_class  ?>" size="15"  maxlength="20">
    <?php if ($w == 'u') { ?><a href="./boardgroupmember_form.php?mb_id=<?php echo $mb['mb_id'] ?>" class="btn_frmline">접근가능그룹보기</a><?php } ?>
                        </td>
                            <?php
                        }
                ...
                <tr>
                    ...
                    <th scope="row"><label for="mb_status">상태</label></th>
                    <td>
                        <select id="mb_status" name="mb_status">
                            <option value="3" <?php echo $mb['mb_status'] == 3 ? "selected" : ""; ?>>예약대기</option>
                            <option value="1" <?php echo $mb['mb_status'] == 1 ? "selected" : ""; ?>>상담중</option>
                            <option value="2" <?php echo $mb['mb_status'] == 2 ? "selected" : ""; ?>>상담가능</option>
                        </select>
                        &nbsp;&nbsp;&nbsp;
                        <label for="mb_lock">상태고정</label> 
                        <input type="checkbox" name="mb_lock" value="1" id="mb_lock" <?php echo $mb['mb_lock'] == 1 ? "checked" : ""; ?>>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="radio" name="mb_gubun" value="1" id="mb_gubun_1" <?php echo $mb['mb_gubun'] == 1 ? "checked" : ""; ?>>
                        <label for="mb_gubun_1">상담사 일반회원</label>
                        <input type="radio" name="mb_gubun" value="2" id="mb_gubun_2" <?php echo $mb['mb_gubun'] == 2 ? "checked" : ""; ?>>
                        <label for="mb_gubun_2">상담사 가족회원</label>
                    </td>
<?php
...
?>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <label for="mb_con_mon">해당월</label>
                        <select name="mb_con_mon">
<?php
for ($kk = 1; $kk <= 12; $kk++) {
    ?>
                                <option value="<?php echo $kk; ?>" <?php echo $kk == $mb['mb_con_mon'] ? "selected" : ""; ?>><?php echo $kk; ?> 월</option>
                                <?php
                            }
                            ?>
                        </select>
                        ,
                        <label for="mb_cal_money">정산금액</label>
                        <input type="text" name="mb_cal_money" value="<?php echo $mb['mb_cal_money'] ?>" id="mb_cal_money" size="10">원
                        ,
                        <label for="mb_con_time_cnt">일반상담</label>
                        <input type="text" name="mb_con_time_cnt" value="<?php echo $mb['mb_con_time_cnt'] ?>" id="mb_con_time_cnt" size="3">건
                        <input type="text" name="mb_con_hour" value="<?php echo $mb_con_arr[0] ?>" id="mb_con_hour" size="3">시간
                        <input type="text" name="mb_con_min" value="<?php echo $mb_con_arr[1] ?>" id="mb_con_min" size="3">분
                        <input type="text" name="mb_con_sec" value="<?php echo $mb_con_arr[2] ?>" id="mb_con_sec" size="3">초
                        ,
                        <label for="mb_con_time2_cnt">할인상담</label>
                        <input type="text" name="mb_con_time2_cnt" value="<?php echo $mb['mb_con_time2_cnt'] ?>" id="mb_con_time2_cnt" size="3">건
                        <input type="text" name="mb_con_hour2" value="<?php echo $mb_con2_arr[0] ?>" id="mb_con_hour2" size="3">시간
                        <input type="text" name="mb_con_min2" value="<?php echo $mb_con2_arr[1] ?>" id="mb_con_min2" size="3">분
                        <input type="text" name="mb_con_sec2" value="<?php echo $mb_con2_arr[2] ?>" id="mb_con_sec2" size="3">초
...
<?php echo help('이미지 크기는 <strong>넓이 ' . $config['cf_member_img_width'] . '픽셀 높이 ' . $config['cf_member_img_height'] . '픽셀</strong>로 해주세요.') ?>
                ...
                <tr>
                    <th scope="row"><label for="mb_9">한줄 소개</label></th>
                    <td colspan="3"><input type="text" name="mb_9" value="<?php echo $mb['mb_9'] ?>" id="mb_9" class="frm_input" size="100" maxlength="255"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="3"><?php echo $editor_html; // 에디터 사용시는 에디터로, 아니면 textarea 로 노출  ?></td>
                </tr>
...
<?php } ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        this.form.mb_leave_date.value = this.value;
                    } else {
                    ...
                    <td>
                        ...
                        this.form.mb_intercept_date.value = this.value;
                    } else {
                        this.form.mb_intercept_date.value = this.form.mb_intercept_date.defaultValue;
                    }">
    ...
    if ($my_social_accounts = social_login_link_account($mb['mb_id'], false, 'get_data')) {
        ...
        foreach ($my_social_accounts as $account) {     //반복문
            ...
            ?>
                ...
                <tr>
                    <th scope="row"><label for="mb_1">상담분야</label></th>
                    <td colspan="3">
                        <?php
                        $qdt = get_cate_list();  // 상담분류내역 가져오기
                        for ($ii = 0; $ii < count($qdt); $ii++) {
                            $mb_1_arr = explode(",", $mb['mb_1']);
                            if (in_array($qdt[$ii]['ca_id'], $mb_1_arr))
                                $checked = "checked";
                            else
                                $checked = "";
                            ?>
                            <label class="type_chk"><input type="checkbox" id="mb_<?php echo $qdt[$ii]['ca_id']; ?>" name="mb_1[]" value="<?php echo $qdt[$ii]['ca_id']; ?>" <?php echo $checked; ?>><?php echo $qdt[$ii]['ca_name']; ?></label>
                            <?php
                        }
                        ?>
                    </td>
                ...
                <tr>
                    <th scope="row"><label for="mb_2">세부분야</label></th>
                    <td colspan="3">
                        <?php
                        $qdt2 = get_hash_list(); // 세부분야내역 가져오기
                        for ($ii = 0; $ii < count($qdt2); $ii++) {
                            $mb_2_arr = explode(",", $mb['mb_2']);
                            if (in_array($qdt2[$ii]['ht_no'], $mb_2_arr))
                                $checked2 = "checked";
                            else
                                $checked2 = "";
                            ?>
                            <label class="type_chk"><input type="checkbox" id="mb_<?php echo $qdt2[$ii]['ht_no']; ?>" name="mb_2[]" value="<?php echo $qdt2[$ii]['ht_no']; ?>" <?php echo $checked2; ?>><?php echo $qdt2[$ii]['ht_name']; ?></label>
    <?php
}
?>
                    </td>
                ...
                <tr>
                    <th scope="row"><label for="mb_hashtag">해시태그</label></th>
                    <td colspan="3"><input type="text" name="mb_hashtag" value="<?= $mb['mb_hashtag'] ?>" id="mb_hashtag" class="frm_input" maxlength="40"></td>
                </tr>
                <tr>
                    <th scope="row"><label for="mb_3">주민등록사진#1</label></th>
                    <td colspan="3"><input type="file" name="mb_3" value="<?php echo $mb['mb_3'] ?>" id="mb_3" class="frm_input" size="30" maxlength="255"><?php if ($mb['mb_3']) echo "<a href='" . G5_DATA_URL . "/temp/" . $mb['mb_no'] . "/" . $mb['mb_3'] . "'>" . $mb['mb_3'] . "</a>"; ?>
                        <?php
                        $icon_file = G5_DATA_PATH . '/temp/' . $mb['mb_no'] . '/' . $mb['mb_3'];
                        if ($mb['mb_3']) {
                            $icon_url = G5_DATA_URL . '/temp/' . $mb['mb_no'] . '/' . $mb['mb_3'];
                            echo '<img src="' . $icon_url . '" alt="" style="width:60%">';
                            echo '<input type="checkbox" id="del_mb_3" name="del_mb_3" value="1">삭제';
                        }
                        ?>
                    </td>
                </tr>
                <tr>
                    <th scope="row"><label for="mb_4">통장앞면사진#2</label></th>
                    <td colspan="3"><input type="file" name="mb_4" value="<?php echo $mb['mb_4'] ?>" id="mb_4" class="frm_input" size="30" maxlength="255"><?php if ($mb['mb_4']) echo "<a href='" . G5_DATA_URL . "/temp/" . $mb['mb_no'] . "/" . $mb['mb_4'] . "'>" . $mb['mb_4'] . "</a>"; ?>
                        <?php
                        $icon_file = G5_DATA_PATH . '/temp/' . $mb['mb_no'] . '/' . $mb['mb_4'];
                        if ($mb['mb_4']) {
                            $icon_url = G5_DATA_URL . '/temp/' . $mb['mb_no'] . '/' . $mb['mb_4'];
                            echo '<img src="' . $icon_url . '" alt="" style="width:60%">';
                            echo '<input type="checkbox" id="del_mb_4" name="del_mb_4" value="1">삭제';
                        }
                        ?>
                    </td>
                </tr>
                <tr>
                    <th scope="row"><label for="mb_5">프로필사진#1</label></th>
                    <td colspan="3"><input type="file" name="mb_5" value="<?php echo $mb['mb_5'] ?>" id="mb_5" class="frm_input" size="30" maxlength="255"><?php if ($mb['mb_5']) echo "<a href='" . G5_DATA_URL . "/temp/" . $mb['mb_no'] . "/" . $mb['mb_5'] . "'>" . $mb['mb_5'] . "</a>"; ?>
                        <?php
                        $icon_file = G5_DATA_PATH . '/temp/' . $mb['mb_no'] . '/' . $mb['mb_5'];
                        if ($mb['mb_5']) {
                            $icon_url = G5_DATA_URL . '/temp/' . $mb['mb_no'] . '/' . $mb['mb_5'];
                            echo '<img src="' . $icon_url . '" alt="" style="width:60%">';
                            echo '<input type="checkbox" id="del_mb_5" name="del_mb_5" value="1">삭제';
                        }
                        ?>
                    </td>
                </tr>
                <tr>
                    <th scope="row"><label for="mb_6">프로필사진#2</label></th>
                    <td colspan="3"><input type="file" name="mb_6" value="<?php echo $mb['mb_6'] ?>" id="mb_6" class="frm_input" size="30" maxlength="255"><?php if ($mb['mb_6']) echo "<a href='" . G5_DATA_URL . "/temp/" . $mb['mb_no'] . "/" . $mb['mb_6'] . "'>" . $mb['mb_6'] . "</a>"; ?>
                        <?php
                        $icon_file = G5_DATA_PATH . '/temp/' . $mb['mb_no'] . '/' . $mb['mb_6'];
                        if ($mb['mb_6']) {
                            $icon_url = G5_DATA_URL . '/temp/' . $mb['mb_no'] . '/' . $mb['mb_6'];
                            echo '<img src="' . $icon_url . '" alt="" style="width:60%">';
                            echo '<input type="checkbox" id="del_mb_6" name="del_mb_6" value="1">삭제';
                        }
                        ?>
                    </td>
                </tr>
                <tr>
                    <th scope="row"><label for="mb_7">프로필사진#3</label></th>
                    <td colspan="3"><input type="file" name="mb_7" value="<?php echo $mb['mb_7'] ?>" id="mb_7" class="frm_input" size="30" maxlength="255"><?php if ($mb['mb_7']) echo "<a href='" . G5_DATA_URL . "/temp/" . $mb['mb_no'] . "/" . $mb['mb_7'] . "'>" . $mb['mb_7'] . "</a>"; ?>
                        <?php
                        $icon_file = G5_DATA_PATH . '/temp/' . $mb['mb_no'] . '/' . $mb['mb_7'];
                        if ($mb['mb_7']) {
                            $icon_url = G5_DATA_URL . '/temp/' . $mb['mb_no'] . '/' . $mb['mb_7'];
                            echo '<img src="' . $icon_url . '" alt="" style="width:60%">';
                            echo '<input type="checkbox" id="del_mb_7" name="del_mb_7" value="1">삭제';
                        }
                        ?>
                    </td>
                </tr>
                <tr>
                    <th scope="row"><label for="mb_8">프로필사진-관리자등록</label></th>
                    <td colspan="3"><input type="file" name="mb_8" value="<?php echo $mb['mb_8'] ?>" id="mb_8" class="frm_input" size="30" maxlength="255"><?php if ($mb['mb_8']) echo "<a href='" . G5_DATA_URL . "/temp/" . $mb['mb_no'] . "/" . $mb['mb_8'] . "'>" . $mb['mb_8'] . "</a>"; ?>
                        <?php
                        $icon_file = G5_DATA_PATH . '/temp/' . $mb['mb_no'] . '/' . $mb['mb_8'];
                        if ($mb['mb_8']) {
                            $icon_url = G5_DATA_URL . '/temp/' . $mb['mb_no'] . '/' . $mb['mb_8'];
                            echo '<img src="' . $icon_url . '" alt="" style="width:60%">';
                            echo '<input type="checkbox" id="del_mb_8" name="del_mb_8" value="1">삭제';
                        }
                        ?>
                    </td>
                </tr>
            <th scope="row"><label for="mb_10">계약서 전자서명</label></th>
            <td colspan="3"><input type="file" name="mb_10" value="<?php echo $mb['mb_10'] ?>" id="mb_10" class="frm_input" size="30" maxlength="255"><?php if ($mb['mb_10']) echo "<a href='" . G5_DATA_URL . "/temp/" . $mb['mb_no'] . "/" . $mb['mb_10'] . "'>" . $mb['mb_10'] . "</a>"; ?>
                <?php
                $icon_file = G5_DATA_PATH . '/temp/' . $mb['mb_no'] . '/' . $mb['mb_10'];
                if ($mb['mb_10']) {
                    $icon_url = G5_DATA_URL . '/temp/' . $mb['mb_no'] . '/' . $mb['mb_10'];
                    echo '<img src="' . $icon_url . '" alt="" style="width:60%">';
                    echo '<input type="checkbox" id="del_mb_10" name="del_mb_10" value="1">삭제';
                }
                ?>
            </td>
            </tr>
