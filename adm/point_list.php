...
$sql_common = " from {$g5['point_table']} gp JOIN {$g5['member_table']} gm ON gp.mb_id = gm.mb_id ";
$sql_search = " where (1) ";
            ...
            <tbody>
                ...
                for ($i = 0; $row = sql_fetch_array($result); $i++) {
                    ...
                    <tr class="<?php echo $bg; ?>">
                        ...
                        <td class="td_left"><div><?php echo $row['mb_hp'] ?></div></td>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php
                            if (isset($mb['mb_id']) && $mb['mb_id']) {
                                echo /* $mb['mb_id']. */ '보유 포인트: ' . number_format($mb['mb_point']) . "점";
                            }
                            ?>
