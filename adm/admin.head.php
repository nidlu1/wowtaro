...
/* 입금일이 하루가 지난 주문은 자동취소처리 */
$cancel_qry = "UPDATE ".$g5['g5_shop_order_table']." SET od_status='취소', od_cancel_price=od_cart_price WHERE od_status='주문' AND od_time < '".date("Y-m-d", strtotime("-1 Days"))." 00:00:00'";
//echo $cancel_qry;
sql_query($cancel_qry);
/* 입금일이 하루가 지난 주문은 자동취소처리 */
