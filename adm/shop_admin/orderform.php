...
function form_submit(f)
{
    ...
    <?php if($od['od_settle_case'] == 'CARD' || $od['od_settle_case'] == 'CARS' || $od['od_settle_case'] == '신용카드' || $od['od_settle_case'] == 'KAKAOPAY' || $od['od_settle_case'] == '간편결제' || ($od['od_pg'] == 'inicis' && is_inicis_order_pay($od['od_settle_case']) )) { ?>
