...
<select name="sfl" id="sfl">
    ...
    <option value="a.iq_hp" <?php echo get_selected($sfl, 'a.iq_hp'); ?>>핸드폰번호</option>
</select>
...
<div class="tbl_head01 tbl_wrap" id="itemqalist">
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td class="td_name"><?php echo $iq_hp; ?></td>
...
<div class="btn_fixed_top">
	...
	<input type="submit" name="act_button" value="1대1문의이동" onclick="document.pressed=this.value" class="btn btn_01">
</div>
</form>
