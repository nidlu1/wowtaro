...
$sql_common = " from {$g5['g5_shop_order_table']} gso LEFT OUTER JOIN {$g5['point_table']} gp ON gso.od_id = gp.od_id $sql_search ";

$sql = " select count(gso.od_id) as cnt " . $sql_common;
$row = sql_fetch($sql);
$total_count = $row['cnt'];
...
<form name="frmorderlist" id="frmorderlist" class="local_sch01 local_sch">
...
<button type="button" id="xls_btn">엑셀다운로드</button>
</form>

<form id="frmorderlist2" class="local_sch03 local_sch">
<div>
    <strong>주문상태</strong>
...
<div>
	...
	<input type="radio" name="od_settle_case" value="5분무료" id="od_settle_case09"   <?php echo get_checked($od_settle_case, '5분무료');    ?>>
    <label for="od_settle_case09">5분무료</label>
	<input type="radio" name="od_settle_case" value="10분무료" id="od_settle_case10"   <?php echo get_checked($od_settle_case, '10분무료');    ?>>
    <label for="od_settle_case10">10분무료</label>
    ...
    <input type="radio" name="od_settle_case" value="추천인5분" id="od_settle_case09" <?php echo get_checked($od_settle_case, '추천인5분');  ?>>
    <label for="od_settle_case09">추천인5분</label>
</div>
...
<div class="sch_last">
    ...
    <input type="submit" value="검색" class="btn_submit">
	<button type="button" id="xls_btn2">엑셀다운로드</button>
</div>
</form>
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" rowspan="3">사용포인트</th>
    ...
    <tr class="orderlist<?php echo ' '.$bg; ?>">
        ...
        <td rowspan="3" class="td_num_right"><?php echo number_format($row['po_point']) < 0 ? number_format($row['po_point']): 0; ?>포인트</td>
    ...
    <?php
        ...
        $po_point          += $row['po_point'] < 0 ? $row['po_point'] : 0;
    }
    ...
    <tr class="orderlist">
        ...
        <td><?php echo number_format($po_point); ?></td>
...
$(function(){
	...
	$("#xls_btn").on("click", function() {
		$("#frmorderlist").attr("action","./orderlist_xls.php");
		$("#frmorderlist").submit();
		$("#frmorderlist").attr("action","./orderlist.php");
	});

	$("#xls_btn2").on("click", function() {
		$("#frmorderlist2").attr("action","./orderlist_xls.php");
		$("#frmorderlist2").submit();
		$("#frmorderlist2").attr("action","./orderlist.php");
	});
});
