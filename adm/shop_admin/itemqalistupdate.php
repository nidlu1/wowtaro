...
//        $sql = "delete from {$g5['g5_shop_item_qa_table']} where iq_id = '{$_POST['iq_id'][$k]}' ";
        $sql = "update {$g5['g5_shop_item_qa_table']} set iq_subject = '<a href='/bbs/qalist.php'>1대1 문의 게시판으로 이동되었습니다(Click!) </a>' , iq_question = '<a href='/bbs/qalist.php'>확인하기 (Click!)</a>' where iq_id = '{$_POST['iq_id'][$k]}'" ;                 
        sql_query($sql);
