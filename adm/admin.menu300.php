...
$menu['menu300'] = array (
	...
	array('300500', '배너관리', G5_ADMIN_URL.'/shop_admin/bannerlist.php', 'scf_banner', 1),
    array('300510', '팝업레이어관리', G5_ADMIN_URL.'/newwinlist.php', 'scf_poplayer'),
    ...
    array('300830', '해시태그관리', G5_ADMIN_URL.'/hashtaglist_v1.php', 'scf_hashtag'),
);
?>