...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" rowspan="2" id="mb_list_cert"><?php //echo subject_sort_link('mb_certify', '', 'desc') ?>회원등급</a></th>
        ...
        <th scope="col" id="mb_list_grp" style="width:150px;">충전시간</th>
    ...
    for ($i=0; $row=sql_fetch_array($result); $i++) {
		...
		$ch = curl_init($user_remaining_secs_addr."?cp=".$cp."&svc=".$svc."&tel=".str_replace("-","",$row['mb_hp'])."&pwd=".substr($row['mb_hp'],-4)."");
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td headers="mb_list_cert"  rowspan="2" class="td_mbcert">
			<?php echo grade_name($row['mb_grade']); ?>
        ...
        <td headers="mb_list_grp" class="td_numsmall"><?php echo $hours; ?>시간 <?php echo $minutes; ?>분 <?php echo $seconds; ?>초<?php //echo $group ?></td>
