...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        <th scope="row"><label for="nw_link">팝업 링크<strong class="sound_only"> 필수</strong></label></th>
        <td>
            <input type="text" name="nw_link" value="<?php echo get_sanitize_input($nw['nw_link']); ?>" id="nw_link" required class="frm_input required" size="80">
        </td>
    </tr>
    <tr>
