...
$total_res = sql_fetch("select count(*) as cnt from sms5_write2 where wr_renum=0 $sql_search");
...
<div class="tbl_head01 tbl_wrap">
    ...
    $qry = sql_query("select * from sms5_write2 where wr_renum=0 $sql_search order by wr_no desc limit $page_start, $page_size");
    ...
    <tr class="<?php echo $bg; ?>">
		...
		<td class="td_tel"><?php echo $res['wr_hp']?></td>
