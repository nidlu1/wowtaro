...
<form name="frmhashtagform" action="./hashtagformupdate.php" onsubmit="return frmhashtagform_check(this);" method="post" enctype="MULTIPART/FORM-DATA" >
...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tbody>
    <tr>
        <th scope="row"><label for="ht_name">세부분야명</label></th>
...
<div class="btn_fixed_top">
    <a href="./hashtaglist.php" class="btn btn_02">목록</a>
...
*/
    ...
    //check_field(f.co_hashtag, "내용을 입력하세요.");
