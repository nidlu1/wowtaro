...
$(document).ready(function() {
	...
	function head_nav(scTop) {
		if (scTop > 80) {
			...
			$('#header').removeClass('on');
			$('#aside').removeClass('on');
			$('#header .h_menu .hm_all .hma_wrap').removeClass("on");
			$('#aside').addClass('on')
		}
	}
	...
	// Go to the next item
	$('#contents .c_list .cl_btn').click(function (){
		if($('#contents .c_list .cl_btn').hasClass("on")){
			$('#contents #mypage-tab').removeClass("on");
			$('#contents .c_list .cl_btn').removeClass("on");
		}else{
			$('#contents #mypage-tab').addClass("on");
			$('#contents .c_list .cl_btn').addClass("on");
		}
	});
