	...
	<footer id="footer">
		...
		<div class="f_notice">
			<div class="wrap">
				...
				<?php }?>
				<?php if ($is_admin || $member['mb_level'] == 3)  { ?>
				<a href="<?php echo G5_URL; ?>/shop/itemuselist.php" class="fn_more">더보기</a>
				<?php } else {?>
				<a href="<?php echo G5_URL; ?>/shop/itemuselist.php" class="fn_more">더보기</a>
				<?php }?>
			</div>
	...
	<div class="p_box">
		...
		<div class="pb_content">
			<div class="pbc_txt">
				...
				<h2 class="title t3 bold cb s05 mb15">상담사 댓글 관리규정</h2>
				<p class="pbct_sub">
				...
				<h2 class="title t3 bold cb s05 mb15">상담후기 작성시 유의사항</h2>
				<p class="pbct_notice">
