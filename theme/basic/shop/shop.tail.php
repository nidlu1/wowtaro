...
?>
    <a href="<?php echo G5_SHOP_URL; ?>/item.php?ca_id=<?php echo $ca_id; ?>&it_id=<?php echo $t5row['mb_no']; ?>" class="teacher-list">
      <div class="teacher_quick teacher_back_small back_taro">
        ...
        신점 일때 : back_shinjeom
      -->
        <img src="<?php echo G5_DATA_URL; ?>/temp/<?php echo $t5row['mb_no']; ?>/<?php echo $t5row['mb_8']; ?>" width="89" height="89" alt="<?php echo $t5row['mb_nick']; ?> 이미지">
      </div>
      <div class="cate">
...
?>
  ...
  <a href="<?php echo G5_BBS_URL; ?>/faq2.php?fm_id=3" class="notice-tel quick-box">
  ...
  <div class="customer quick-box">
    <p>고객센터</p>
    <a href="<?php echo G5_BBS_URL; ?>/faq2.php?fm_id=3" class="cutomer_border_wr">
...
<div class="inner">
  <div class="tail-box clearfix">
    <div class="counselor boxes">
      <h2>베스트 상담사 신청</h2>
      <p>실력과 긍정 마인드를 겸비한<br>
        신선운세의 베스트 상담사를 모십니다.</p>
      <a href="<?php echo G5_BBS_URL; ?>/register2.php">베스트 상담사 신청하기</a>
    </div>
    ...
    <div class="customer boxes">
      ...
      <ul class="icon-wr clearfix">
        <li>
          <a class="ico1" href="<?php echo G5_BBS_URL; ?>/qalist.php">
            <img src="/fortune-img/customer-ico1.png" alt="1:1고객문의">
          </a>
          <p>1:1고객문의</p>
        </li>
        <li>
          <a class="ico2" href="<?php echo G5_BBS_URL; ?>/faq2.php?fm_id=3">
            <img src="/fortune-img/customer-ico2.png" alt="이용안내">
          </a>
          <p>이용안내</p>
        </li>
        <li>
          <a class="ico3"  href="<?php echo G5_BBS_URL; ?>/faq.php?fm_id=4">
  ...
  <div class="ft_top clearfix">
    <div class="inner">
      ...
      <ul class="ft_left clearfix">
        ...
        <li><a href="<?php echo G5_URL; ?>/payment.php">코인충전</a></li>
        <li><a href="<?php echo G5_BBS_URL; ?>/register2.php"><strong>베스트상담사신청</strong></a></li>
         <?
		if (is_mobile()){
		?>
