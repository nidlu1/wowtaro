...
<div id="hd">
    ...
    <div id="tnb" class="clearfix">
      <div class="inner">
        ...
        <ul class="left clearfix">
          ...
          <!-- <span class="bar"></span> -->
          <li>
            <a href="https://post.naver.com/sinseonunse?isHome=1" target="_blank">
        ...
        <ul class="right clearfix">
          <div id="hd_sch">
              <h3>쇼핑몰 검색</h3>
              <i class="xi-close-thin" id="schClose"></i>
              <form name="frmsearch1" action="<?php echo G5_SHOP_URL; ?>/search.php" onsubmit="return search_submit(this);">
                <label for="sch_str" class="sound_only">검색어<strong class="sound_only"> 필수</strong></label>
                <select name="seach_category" id="sch_str" style="width: 20%">
                    <option value="level3">선생님</option>
                </select>
              <label for="sch_str" class="sound_only">검색어<strong class="sound_only"> 필수</strong></label>
              <input type="text" name="q" value="<?php echo stripslashes(get_text(get_search_string($q))); ?>" id="sch_str" placeholder="선생님 검색" required style="width: 60%">
            ...
            <?php } ?> -->
            <?php if ($is_member) { ?>
              <li class="search-btn"><i class="xi-search"></i></li>
            <li><a href="<?php echo G5_BBS_URL; ?>/logout.php?url=shop">로그아웃</a></li>
            <?php if ($is_admin) {  ?>
            <li class="tnb_admin"><a href="<?php echo G5_ADMIN_URL; ?>/shop_admin/"><b>관리자</b></a></li>
            <li><a href="<?php echo G5_BBS_URL; ?>/board.php?bo_table=notice2/"><b>공지사항</b></a></li>
            <li><a href="<?php echo G5_BBS_URL; ?>/board.php?bo_table=event_form/"><b>이벤트</b></a></li>
            <?php }  ?>
            <?php } else { ?>
            <li class="search-btn"><i class="xi-search"></i></li>
			...
			<li><a href="<?php echo G5_SHOP_URL; ?>/orderinquiry2.php">마이페이지</a></li>
			<?php } else { ?>
            <li><a href="<?php echo G5_URL; ?>/mypage_payment_list.php">마이페이지</a></li>
			<?php } ?>
            <li><a href="<?php echo G5_BBS_URL; ?>/faq2.php?fm_id=3">고객센터</a></li>
            <li><a href="<?php echo G5_URL; ?>/payment.php"> <img class="top-coin" src="/fortune-img/top-ico4.png" alt="코인이미지"> 코인충전</a></li>
        </ul>
      </div><!--inner-->
    </div><!--tnb-->
    ...
    <div id="hd_wrapper" class="clearfix">
        <div id="logo"><a href="<?php echo G5_URL; ?>/index.php" alt="<?php echo $config['cf_title']; ?>"><img src="/fortune-img/logo.png" class="main_logo"></a></div>
        ...
        <div class="left-banner">
          <p class="red-box">TOTAL VISITOR</p>
          <p>신선운세의 누적 방문자수는<br>
            <span class="num">
			<?php
        ...
        <div class="right-banner quick-box" style="width: 100px; margin-top: 40px">
            <div style=" text-align: center;">
                <a href="<?php echo $event_href; ?>">
                <img src="/fortune-img/quick-clock.png" alt="무료코인">
                <div class="quick_txt" style="font-size: 15px;">
                  EVENT<br><b><span><?php echo $config['cf_1']; ?>분</span>무료상담</b>
                  </div>
                </a>
      <!--          <a href="/shop/itemuselist.php?gubun=best">
                <img src="/fortune-img/top-best.png" alt="베스트후기 보러가기">
                <p>베스트후기 보러가기 <i class="xi-angle-right-min"></i></p>
                </a>-->
            </div>
        </div>
...
<!-- 상품 카테고리 및 게시판 navigation은 이 파일을 확인해주세요 -->
