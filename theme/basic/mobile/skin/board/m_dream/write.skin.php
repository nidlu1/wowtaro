...
<div class="c_hero" id="sub_review">
	<strong>신선운세 <mark>무료 꿈해몽</mark></strong>
</div>
<div class="c_list">
	<div class="cl_menu">
		<a href="<?php echo G5_URL; ?>"><i></i><span class="blind">HOME</span></a>
		<span>신선운세</span>
		<span><mark><a href="/bbs/board.php?bo_table=dream" class="sct_here ">무료 꿈해몽</a></mark></span>
	</div>
</div>
			...
			<div class="cab_form">
				...
				<div class="cabf_wrap">
					...
					<div class="cabf_content">
						<select class="cabfc_select required" name="wr_1" required>
						<option value="">상담사 회원</option>
						<?php
						$qry = "SELECT * FROM ".$g5['member_table']." WHERE mb_level='3' ORDER BY mb_nick ASC";
						$qres = sql_query($qry);
						while ( $qrow = sql_fetch_array($qres) ) {
							$mb_st = counsel_stat($qrow['mb_id']);
							//var_dump($mb_st);
							if ( $mb_st ) $qrow['mb_status'] = $mb_st;
				...
				<div class="cabf_wrap">
					...
					<div class="cabf_content">
						...
						<div class="blind" id="autosave_pop">
