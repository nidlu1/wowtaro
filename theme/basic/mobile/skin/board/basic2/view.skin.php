...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <?php } ?>
		<li><a href="<?php //echo $list_href ?><?php echo '/myboard.php?bo_table='.$_REQUEST['bo_table'].'&amp;page='.$page.$qstr; ?>" class="btn_list"><i class="fa fa-list" aria-hidden="true"></i> 목록</a></li>
