        ...
        <ul>
            ...
            <li class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
                ...
                <div class="bo_subject">
                    ...
                    <a href="<?php //echo $list[$i]['href'] ?><?php echo '/myboard.php?bo_table='.$_REQUEST['bo_table'].'&amp;wr_id='.$list[$i]['wr_id'].$qstr; ?>" class="bo_subject">
                ...
                <div class="bo_info">
                    ...
                    <span class="bo_date"><?php if ($list[$i]['comment_cnt']) { ?><span class="sound_only">댓글</span><i class="fa fa-commenting-o" aria-hidden="true"></i><?php echo $list[$i]['comment_cnt']; ?><span class="sound_only">개</span><?php } ?> <?php echo $list[$i]['datetime'] ?></span>
