...
<article id="bo_v" style="width:<?php echo $width; ?>">
    <header>
        ...
        <p><span class="sound_only">작성일</span><?php echo date("y-m-d H:i", strtotime($view['wr_datetime'])) ?></p>
		<p><span class="sound_only">선생님인원</span>남자 : <?php echo $view['wr_5'] ?> / 여자 : <?php echo $view['wr_6'] ?></p>
		<p><span class="sound_only">기간</span><?php echo $view['wr_3'] ?> ~ <?php echo $view['wr_4'] ?></p>
		<p><span class="sound_only">지역</span><?php echo $view['wr_2'] ?></p>
		<p><span class="sound_only">연락처</span><?php echo $view['wr_1'] ?></p>
		<p><span class="sound_only">이메일</span><?php echo $view['wr_email'] ?></p>
    </header>
