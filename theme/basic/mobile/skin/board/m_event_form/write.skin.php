...
<div class="c_area">
	<div class="ca_top">
		<div class="cat_pic">
			<img src="/images/m/eventform/pic_top.jpg" alt="이미지">
		</div>
	</div>
	<div class="ca_event">
	...
	<div class="wrap small">
		...
		<form name="fwrite" id="fwrite" action="<?php echo $action_url ?>" onsubmit="return fwrite_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off" style="width:<?php echo $width; ?>">
				...
				<div class="from_wrap t1 mb50">
					...
					<div class="caf_item">
						...
						<div class="write_div">
							...
							<textarea id="wr_content" name="wr_content" class="caf_textarea required" style="Height:120px;" placeholder="추가사항을 입력하세요." required></textarea>
			...
			<ul class="caf_buttons">
				<li><a href="/index.php" class="btn">취소</a></li>
				<li><input type="submit" value="작성완료" id="btn_submit" accesskey="s" class="btn t1"></li>
			</ul>
		</form>
	</div>
	<!-- } 게시물 작성/수정 끝 -->
