...
<div class="c_area">
    ...
    <!-- 검색결과 시작 { -->
        ...
        if (file_exists($list_file)) {
			...
			$sql = "SELECT * FROM g5_member WHERE mb_level='3' AND concat(mb_nick,' ',mb_id) like '%루이스%' ORDER BY mb_status ASC, rand()";
			//echo $sql;
    ...
    <!-- } 검색결과 끝 -->
		...
		<ul class="ca_member">
			...
			if ($i == 1)
				// echo "<p class=\"sct_noitem title cg bold\">등록된 선생님이 없습니다.</p>\n";
			?>
		</ul>
	</div>
</div>
