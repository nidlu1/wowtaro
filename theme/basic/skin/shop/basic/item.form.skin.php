  ...
  <div class="product_ornarment"></div>
        ...
        <div id="sit_star_sns">
          <ul>
            ...
            <li>
              ...
              <img src="/shop/img/s_star5.png" alt="" class="sit_star" width="100">
              <span>5</span>
            </li>
            ...
            <li>
              <span>상담후기</span><strong><?php echo $it['it_use_cnt']; ?></strong>
            </li>
            <li>
              <span>상담사 댓글</span><strong>420</strong>
            </li>
          </ul>
        </div>
        </div>
    ...
    <section id="sit_ov" class="2017_renewal_itemform">
      <div class="sit_buttons">
        ...
        <div class="status_possible">상담가능</div>
        <a href="javascript:item_wish(document.fitem, '<?php echo $it['it_id']; ?>');"><i class="xi-home-o"></i><span>단골등록</span></a>
      </div>
      ...
      <div class="sit_ov_bottom">
        <div class="counsel_wrap default_coun">
          <label>할인전화상담</label>
          <strong>060 -300 -1544 + 008</strong>
          <span>전화연결 후 + 고유번호 001번을 눌러주세요.</span>
        </div>
