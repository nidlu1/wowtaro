    ...
    <div class="new_win_con form_01">
        ...
        <ul>
            <li>
                ...
                <input type="text" name="is_reply_subject" value="<?php echo get_text($use['is_reply_subject']); ?>" id="is_reply_subject" required class="required frm_input full_input"  maxlength="250" placeholder="제목">
            </li>
            <li>
