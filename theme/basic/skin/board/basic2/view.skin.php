...
<article id="bo_v" style="width:85%">
    <header>
        <h2 id="bo_v_title">
    ...
    <div id="bo_v_top">
        ...
        <ul class="bo_v_com">
           <li><a href="<?php //echo $list_href ?><?php echo '/bbs/board.php?bo_table='.$_REQUEST['bo_table'].'&amp;page='.$page.$qstr; ?>" class="btn_b01 btn"><i class="fa fa-list" aria-hidden="true"></i> 목록</a></li>
