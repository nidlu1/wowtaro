        ...
        <div class="limit_text limit_text_static">
          * 세부분야는 3개까지 선택 가능합니다.
            ...
            <li>
              ...
              <input type="text" name="mb_hashtag" value="<?php echo $member['mb_hashtag'] ?>" id="reg_mb_hashtag" class="frm_input" maxlength="40" placeholder="검색될 태그 입력">
              <span class="limit_text">40자 이내</span>
            </li>
            <li>
            ...
            <li>
              ...
              <canvas id="myCanvas" style="background-color:aliceblue" width="550" height="800"></canvas>
            </li>
            <li>
              <label class="form_label"></label>
              <input type="text" size="40" value="서명한 계약서를 저장한 후 파일을 첨부해주세요" readonly="">
            </li>
            <li>
              <label class="form_label"> 전자서명 첨부하기 </label>
              <input type="file" name="mb_10" id="reg_mb_10" placeholder="전자서명">
            </li>
            <!--
			<li>
              <label class="form_label">프로필사진#3</label>
              <input type="file" name="mb_7" id="reg_mb_7" required class="required" placeholder="주민등록사진">
            </li-->
            <!--li>
    ...
    function fregisterform_submit(f)
    {
		...
		*/
        ...
        return true;
              ...
              <script src="<?= G5_JS_URL?>/canvas.js"/>
<!-- } 회원정보 입력/수정 끝 -->
