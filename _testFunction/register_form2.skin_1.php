...
<?php } ?>
            <div id="register_form"  class="form_01" style="width: 900px">
                <div>
                    <ul>
<?php if ($w != 'u') { ?>
...
<?php } else { ?>
                            ...
                            <li>
                                ...
                                <input type="text" name="mb_cert" placeholder="승인받은 날짜 노출" value="<?php echo $member['mb_cert']; ?>" disabled class="frm_input strip_input" style="border: 0;">
                            </li>
                            <!--//승인받은날짜 노출하기-->
                            ...
                            <li>
                                ...
                                <input type="text" name="mb_id" placeholder="이메일만 사용가능합니다" value="<?php echo $member['mb_id'] ?>" id="reg_mb_id" <?php echo $required ?> <?php echo $readonly ?> class="frm_input strip_input <?php echo $required ?> <?php echo $readonly ?>" minlength="3" maxlength="20" placeholder="아이디" style="border: 0;"><!--button type="button" class="btn_frmline">인증확인</button-->
                            ...
                            <li>
                                ...
                                <input type="password" name="mb_password" id="reg_mb_password" placeholder="비밀번호를 입력해주세요" <?php echo $required ?> class="frm_input  <?php echo $required ?>" minlength="3" maxlength="20" placeholder="비밀번호">
                            </li>
                            <li>
...
<?php } ?>
                        <li>
                            ...
                            <input type="text" id="reg_mb_name" name="mb_name" value="<?php echo get_text($member['mb_name']) ?>" <?php echo $required ?> <?php echo $readonly; ?> class="frm_input strip_input <?php echo $required ?> <?php echo $readonly ?>" size="10" placeholder="이름" <?php echo $w == 'u' ? 'style="border: 0;"' : ''; ?>>
                        </li>
<?php if ($req_nick) { ?>
                            <li>
    ...
    <?php if ($w != 'u') { ?>
                                    ...
                                    <input type="text" name="mb_nick" value="<?php echo isset($member['mb_nick']) ? get_text($member['mb_nick']) : ''; ?>" id="reg_mb_nick" required class="frm_input required nospace  strip_input" size="10" maxlength="20" placeholder="타사이트 닉네임 불가 / 네이버 페이 광고성 상담 카톡문자 개인적으로 활동 하고 있는 닉네임 불가"><button type="button" class="btn_frmline" id="dup_nick">중복확인</button>
    ...
    <?php } else { ?>
                                    <input type="hidden" name="mb_nick_default" value="<?php echo isset($member['mb_nick']) ? get_text($member['mb_nick']) : ''; ?>">
                                    <input type="text" name="mb_nick" value="<?php echo isset($member['mb_nick']) ? get_text($member['mb_nick']) : ''; ?>" id="reg_mb_nick" class="frm_input nospace strip_input" style="border: 0;" size="10" maxlength="20" readOnly>
                            <?php } ?>
                            </li>
<?php } ?>
...
<?php if ($config['cf_use_hp'] || $config['cf_cert_hp']) { ?>
    ...
    <?php $arr_hp = explode("-", $member['mb_hp']); ?>
                                <select id="mb_hp1" name="mb_hp1" class="frm_input third_input" onchange="resetAuth()">
                                ...
                                <input type="text" name="mb_hp2" value="<?php echo get_text($arr_hp[1]) ?>" id="mb_hp2" <?php echo ($config['cf_req_hp']) ? "required" : ""; ?> class="frm_input third_input <?php echo ($config['cf_req_hp']) ? "required" : ""; ?>" maxlength="4" onchange="resetAuth()">
                                <input type="text" name="mb_hp3" value="<?php echo get_text($arr_hp[2]) ?>" id="mb_hp3" <?php echo ($config['cf_req_hp']) ? "required" : ""; ?> class="frm_input third_input <?php echo ($config['cf_req_hp']) ? "required" : ""; ?>" maxlength="4" onchange="resetAuth()">
                                <!-- 화면 확인 상 넣은 버튼으로 실제 인증번호 개발시 현 버튼은 필요없음 2019-05-02 -->
                                <button type="button" id="btnSmsSend" class="btn_frmline">인증번호 요청</button>
                                <!-- //화면 확인 상 넣은 버튼으로 실제 인증번호 개발시 현 버튼은 필요없음 2019-05-02 -->
...
<?php } ?>
    ...
    <?php if ($config['cf_req_addr']) { ?><strong class="sound_only">필수</strong><?php } ?>
                                ...
                                <input type="text" name="mb_zip" value="<?php echo $member['mb_zip1'] . $member['mb_zip2']; ?>" id="reg_mb_zip" <?php echo $config['cf_req_addr'] ? "required" : ""; ?> class="frm_input strip_input <?php echo $config['cf_req_addr'] ? "required" : ""; ?>" size="5" maxlength="6"  placeholder="우편번호" readOnly>
                                ...
                                <input type="text" name="mb_addr1" value="<?php echo get_text($member['mb_addr1']) ?>" id="reg_mb_addr1" <?php echo $config['cf_req_addr'] ? "required" : ""; ?> class="frm_input frm_address <?php echo $config['cf_req_addr'] ? "required" : ""; ?>" size="50"  placeholder="기본주소" readOnly>

                                <label for="reg_mb_addr3" class="form_label"></label>
                                <input type="text" name="mb_addr3" value="<?php echo get_text($member['mb_addr3']) ?>" id="reg_mb_addr3" class="frm_input frm_address " size="50" readonly="readonly"  placeholder="참고항목" readOnly>
                        ...
                        <li>
                            ...
                            <div class="frm_input required">
                                ...
                                for ($ii = 0; $ii < count($qdt); $ii++) {
                                    ?>
                                    <label class="type_chk"><input type="checkbox" id="mb_1_<?php echo $qdt[$ii]['ca_id']; ?>" name="mb_1[]" value="<?php echo $qdt[$ii]['ca_id']; ?>" <?php echo in_array($qdt[$ii]['ca_id'], $bcat_arr) ? "checked" : ""; ?>><?php echo $qdt[$ii]['ca_name']; ?></label>
                                    <?php
                                }
                                ?>
                            </div>
                        ...
                        <li>
                            ...
                            <div class="frm_input required">
                                ...
                                for ($ii = 0; $ii < count($qdt2); $ii++) {
                                    ?>
                                    <label class="type_chk"><input type="checkbox" id="mb_2_<?php echo $qdt2[$ii]['ht_no']; ?>" name="mb_2[]" value="<?php echo $qdt2[$ii]['ht_no']; ?>" <?php echo in_array($qdt2[$ii]['ht_no'], $scat_arr) ? "checked" : ""; ?>><?php echo $qdt2[$ii]['ht_name']; ?></label>
                                    <?php
                                }
                                ?>
                                <div class="limit_text limit_text_static">
                                    * 세부분야는 3개까지 선택 가능합니다.
                                </div>
                            </div>
                        </li>
                        <li>
                            <label class="form_label">해시태그</label>
                            <input type="text" name="mb_hashtag" value="<?php echo $member['mb_hashtag'] ?>" id="reg_mb_hashtag" class="frm_input" maxlength="40" placeholder="검색에 노출할 해시태그">
                            <span class="limit_text">태그구분은 ,로 해주세요.</span>
                        </li>
                        <li>
                            <label class="form_label">한줄소개</label>
                            <input type="text" name="mb_9" value="<?php echo $member['mb_9'] ?>" id="reg_mb_9" class="frm_input" maxlength="20" placeholder="나를 어필할 수 있는 한줄소개">
                            <span class="limit_text">20자 이내</span>
                        </li>
                        <li>
                            <label class="form_label">상담사 경력</label>
                            <textarea name="mb_profile" id="reg_mb_profile" <?php echo $config['cf_req_profile'] ? "required" : ""; ?> class="<?php echo $config['cf_req_profile'] ? "required" : ""; ?>" placeholder="상담사 경력" <?php echo $w == 'u' ? 'style="border: 0;" readOnly' : ''; ?>><?php echo $member['mb_profile'] ?></textarea>
                        </li>
                        <li>
                            <label class="form_label">상담사 소개글</label>
                            <div class="editor">
                                <textarea name="mb_memo" id="reg_mb_memo" class="" style="height:300px;<?php echo $w == 'u' ? 'border: 0;' : ''; ?>" placeholder="상담사 소개글" <?php echo $w == 'u' ? ' readOnly' : ''; ?>><?php echo $member['mb_memo'] ?></textarea>
<?php //echo $editor_html; // 에디터 사용시는 에디터로, 아니면 textarea 로 노출    ?>
                                <span class="limit_text">300자 이내</span>
                            </div>
                        </li>
                        <li>
                            <label class="form_label">주민등록사진#1</label>
                            <input type="file" name= "mb_3" id="reg_mb_3" placeholder="주민등록사진">
                        </li>
                        <li>
                            <label class="form_label">통장앞면사진#2</label>
                            <input type="file" name="mb_4" id="reg_mb_4" placeholder="주민등록사진">
                        </li>
                        <li>
                            <label class="form_label">프로필사진#1</label>
                            <input type="file" name="mb_5" id="reg_mb_5" placeholder="주민등록사진">
                        </li>
                        <li>
                            <label class="form_label">프로필사진#2</label>
                            <input type="file" name="mb_6" id="reg_mb_6" placeholder="주민등록사진">
                        </li>
                        <li>
                        ...
                        <li>
                            <label class="form_label">전자서명</label>
                            <input id="draw_text" required value="" placeholder="주민번호를 입력해주세요" style="margin-right: 15px">
                            <input id="draw_text2" required value="" placeholder="계좌번호를 입력해주세요">
                        </li>
                        <li>
                            <label class="form_label"></label>
                            <input id="draw_text3" required value="" placeholder="주소를 입력해주세요" style="margin-right: 15px">
                            <input id="draw_text4" required1 value="" placeholder="이름을 입력해주세요">
                        </li>
                        <li>
                            <label class="form_label">전자서명</label>
                        ...
                        <li>
                            ...
                            <input type="file" name="mb_10" id="reg_mb_10" required class="required" placeholder="계약서">
                        </li>
                        <!--li>
                ...
                <div class="btn_confirm">
                    ...
                    <input type="submit" value="<?php echo $w == '' ? '상담사신청' : '정보수정'; ?>" id="btn_submit" class="btn_submit" accesskey="s">
                </div>
